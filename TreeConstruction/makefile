...
SRCS = MainProgram.c
#vec_sum_a.c vec_sum_b.c std_dev.c matrix_vector_multiplication.c std_dev.c mergesort.c
...
LIBS = -lm -I/import/helium-share/csgrad/azizmma/ParallelProject/Include/
